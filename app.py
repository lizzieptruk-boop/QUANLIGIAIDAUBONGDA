...
# 4. GIAO DIỆN CHÍNH
st.title("⚽ QUẢN LÝ BÓNG ĐÁ - CHẾ ĐỘ XÁC NHẬN TỔNG")
...
with tab1:
    st.subheader("Bảng xếp hạng (Dữ liệu chính thức)")
        ...
        with st.expander(f"Vòng {int(v)}"):
            ...
            for idx, r in v_matches.iterrows():
                ...
                if n1 != r.iloc[5] or n2 != r.iloc[6]:
                    ...
                    st.session_state.has_changes = True # Đánh dấu có thay đổi nhưng chưa lưu
